...
STDRFM2GCALL RFM2gUserMemoryBytes(RFM2GHANDLE rh, void **UserMemoryPtr,
    RFM2G_UINT32 Offset, RFM2G_UINT32 Bytes);

STDRFM2GCALL RFM2gUnMapUserMemory(RFM2GHANDLE rh, void **UserMemoryPtr, 
    RFM2G_UINT32 Pages);

STDRFM2GCALL RFM2gUnMapUserMemoryBytes(RFM2GHANDLE rh, void **UserMemoryPtr, 
    RFM2G_UINT32 Bytes); 
...
/* Only implemented on 64 bit Operating Systems */
...
/* NOTE: Application programs should not use the following functions unless 
         directed to do so by GE Fanuc Embedded Systems, Inc. support 
         personnel. */
...
STDRFM2GCALL RFM2gMapDeviceMemory(RFM2GHANDLE rh, RFM2GREGSETTYPE regset, void **DeviceMemoryPtr);

STDRFM2GCALL RFM2gUnMapDeviceMemory(RFM2GHANDLE rh, RFM2GREGSETTYPE regset, void **DeviceMemoryPtr);
